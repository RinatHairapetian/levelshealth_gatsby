                  ...
                  <div className={`${s.disclaimerSocial} lr-md lb lb-md-none`}>
                    ...
                    <ul className={s.socials}>
                      <li className="icon-facebook">
                        <a href="https://facebook.com/LevelsHealth" target="_blank" rel="noreferrer" aria-label="Go to Levels Facebook" data-location="external">
                      ...
                      <li className="icon-instagram">
                        <a href="https://www.instagram.com/levels/" target="_blank" rel="noreferrer" aria-label="Go to Levels Instagram" data-location="external">
                      ...
                      <li className="icon-twitter">
                        <a href="https://twitter.com/levels" target="_blank" rel="noreferrer" aria-label="Go to Levels Twitter" data-location="external">
                      ...
                      <li className="icon-youtube">
                        <a href="https://www.youtube.com/channel/UClwMr26t47qS1L9S59P35Mg/" target="_blank" rel="noreferrer" aria-label="Go to Levels Youtube" data-location="external">
                      ...
                      <li className="icon-linkedin">
                        <a href="https://www.linkedin.com/company/levels-health/" target="_blank" rel="noreferrer" aria-label="Go to Levels LinkedIn" data-location="external">
                          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li className="icon-apple">
                        <a href="https://podcasts.apple.com/ca/podcast/a-whole-new-level/id1563263076" target="_blank" rel="noreferrer" aria-label="Go to Levels on Apple Podcasts" data-location="external">
                      ...
                      <li className="icon-medium">
                        <a href="https://medium.com/levelshealth" target="_blank" rel="noreferrer" aria-label="Go to Levels on Medium" data-location="external">
